...
class Labyrinthe:
    ...
    def affiche(self,window):
        ...
        wall2 = pygame.image.load("murs2.jpg").convert()
        exitt = pygame.image.load("sortie2.jpg").convert()
        entrance = pygame.image.load("entree2.jpg").convert()
        emptyness = pygame.image.load("vide.png").convert()
        perso = pygame.image.load("perso2.jpg").convert()
        obj = pygame.image.load("object.png").convert()
        guard = pygame.image.load("gardien.png").convert()
        size_cell = 50
